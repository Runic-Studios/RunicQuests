...
public class QuestObjectiveBreak extends QuestObjective {
	...
	public QuestObjectiveBreak(Material blockMaterial, Integer blockAmount, Location blockLocation, List<String> goalMessage, List<String> execute, Integer objectiveNumber, List<String> completedMessage) {
	...
	public QuestObjectiveBreak(Material blockMaterial, Integer blockAmount, Location blockLocation, List<QuestItem> questItems, List<String> goalMessage, List<String> execute, Integer objectiveNumber, List<String> completedMessage) {
