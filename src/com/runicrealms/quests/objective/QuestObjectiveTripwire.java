...
public class QuestObjectiveTripwire extends QuestObjective {
	...
	public QuestObjectiveTripwire(Location tripwire1, Location tripwire2, String goalMessage, List<String> execute, Integer objectiveNumber, List<String> completedMessage) {
	...
	public QuestObjectiveTripwire(Location tripwire1, Location tripwire2, List<QuestItem> questItems, String goalMessage, List<String> execute, Integer objectiveNumber, List<String> completedMessage) {
